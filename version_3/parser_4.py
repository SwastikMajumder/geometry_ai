...
def take_input(equation):#"sin(3)+1+2"
  ...
  def rename_internal_undesired_nodes(node, parent_name=None):
    ...
    relevant_nodes = {"triangle", "congruent", "angle", "add", "sub", "line", "parallel", "exist", "and", "eq"}
  ...
  def remove_past(node):
      if len(node.children) == 1 and node.name not in {"triangle", "congruent", "angle", "add", "sub", "line", "parallel", "exist", "and", "eq"}:
  ...
  def name_replace(tree_node):
      ...
      if tree_node.name in {"triangle", "congruent", "angle", "add", "sub", "line", "parallel", "exist", "and", "eq"}:
