...
def string_equation_helper(equation_tree):
    ...
    sign = {"f_xparallel": ",", "f_xcongruent": ",", "f_congruent": ",", "f_triangle": "?", "f_add": "+", "f_and": "^", "f_dif": "?", "f_mul": "*", "f_eq": "=", "f_sub": "-", "f_angle": "?", "f_xangle": "?", "f_parallel": ",", "f_xline": "?", "f_exist": "?", "f_line": "?"} # operation symbols
...
while True:
    ...
    if string[:13] == "draw triangle":
        ...
        eq_list.append(fix_angle_line(parser_4.take_input(string.split(" ")[1])))
        #print(eq_list[-1])
        fx_call.append(None)
        #process()
        #continue
